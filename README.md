...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Santosh%20Pal&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Full%20Stack%20Developer%20%7C%20Generative%20AI%20%7C%20Agentic%20AI&descAlignY=55&descSize=18" width="100%"/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=00D9FF&center=true&vCenter=true&width=600&lines=Hey+there!+I'm+Santosh+Pal+👋;Full+Stack+Developer+%7C+MERN+Stack;Generative+AI+%26+Agentic+AI+Builder;Building+Intelligent+Web+Applications;Open+to+Collaborations+%26+Freelance!)](https://git.io/typing-svg)
...
```
🧠  Agentic AI Workflows   →  AutoGen / CrewAI / LangGraph
📄  RAG Applications       →  LangChain + Vector DBs
💬  AI Chatbots            →  OpenAI GPT + Custom APIs
🔗  AI + MERN Integration  →  Full Stack AI-powered Apps
```
